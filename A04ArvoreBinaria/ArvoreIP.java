...
public class ArvoreIP extends Arvore{
    //=====INSERCAO POR PASSAGEM DE PAI=====
        public void insert(int value){
            ...
            else if (value < root.value) insert(value, root, root.left);
            // senão, se o valor for MAIOR do que a RAIZ, caminha pra DIREITA
            else if (value > root.value) insert(value, root, root.right);
        }
        ...
        public void insert(int value, Node parent, Node son){
            ...
            else if (value < son.value) insert(value, son, son.left);
            // senão, se o valor for MAIOR do que o FILHO, caminha pra DIREITA
            else if (value > son.value) insert(value, son, son.right);
        }
    //=====INSERCAO POR PASSAGEM DE PAI=====
